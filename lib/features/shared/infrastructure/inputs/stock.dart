...
class Stock extends FormzInput<int, StockError> {
  ...
  String? get errorMessage {
    ...
    if ( displayError == StockError.format ) return 'El campo no tiene el formato de numero';
  ...
  StockError? validator(int value) {
    ...
    final isNumber = int.tryParse(value.toString()) ?? '-1';
    if (isNumber == '-1') return StockError.format;
